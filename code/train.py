...
from ultralytics.yolo.utils import RANK, WORLD_SIZE
...
def main(opt):
    ...
    # Use the model
    model.train(data=opt.data, epochs=opt.epochs, batch=opt.batch, imgsz=opt.imgsz, project=opt.project, name=opt.name, workers=opt.workers, device=opt.device)  # train the model


if __name__ == '__main__':
    
    print(os.listdir('/opt/ml/input/data/'))
    # print('hello', WORLD_SIZE)
